...
class TestWhisperConfig:
    ...
    def test_custom_values(self):
        ...
        config = WhisperConfig(model_size="small.en", device="cuda", compute_type="float16", beam_size=3, language="de")
...
class TestTranscriber:
    ...
    def test_transcribe_returns_segments(self, mock_whisper_model):
        ...
        mock_whisper_model.return_value.transcribe.return_value = (iter([mock_segment]), mock_info)
...
class TestTranscriptSegment:
    ...
    def test_creation(self):
        ...
        segment = TranscriptSegment(start=0.0, end=5.0, text="Hello world", speaker="SPEAKER_00", confidence=0.95)
